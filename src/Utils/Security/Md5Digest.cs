...
namespace LibWindPop.Utils.Security
{
         ...
         : GeneralDigest
    {
        ...
        */
        ...
        {
            X[xOff] = BinaryPrimitives.ReadUInt32LittleEndian(word);
        ...
        public override int DoFinal(Span<byte> output)
        {
            ...
            BinaryPrimitives.WriteUInt32LittleEndian(output[..4], H1);
            BinaryPrimitives.WriteUInt32LittleEndian(output.Slice(4, 4), H2);
            BinaryPrimitives.WriteUInt32LittleEndian(output.Slice(8, 4), H3);
            BinaryPrimitives.WriteUInt32LittleEndian(output.Slice(12, 4), H4);

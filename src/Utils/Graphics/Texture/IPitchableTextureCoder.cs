...
namespace LibWindPop.Utils.Graphics.Texture
{
    ...
    public interface IPitchableTextureCoder : ITextureCoder
    {
        ...
        /// <param name="pitch">Texture Pitch</param>
        /// <param name="dst_bitmap">Bitmap to save BGRA8888 data</param>
        void Decode(ReadOnlySpan<byte> src_data, int width, int height, int pitch, RefBitmap dst_bitmap);
        ...
        /// <param name="height">Texture Height</param>
        /// <param name="pitch">Texture Pitch</param>
        void Encode(RefBitmap src_bitmap, Span<byte> dst_data, int width, int height, int pitch);
    }
}

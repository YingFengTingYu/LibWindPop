...
{
    public unsafe struct A4_R4_G4_B4_UShortBE : ITextureCoder, IPitchableTextureCoder, IXbox360D3D9Texture
    {
        ...
        public void Encode(RefBitmap srcBitmap, Span<byte> dst_data, int width, int height, int pitch)
        {
            ThrowHelper.ThrowWhen(width < 0 || height < 0 || pitch < 0);
            int tempDataIndex;
            YFColor tempColor;

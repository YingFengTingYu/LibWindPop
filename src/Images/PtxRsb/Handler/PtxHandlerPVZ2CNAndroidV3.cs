...
{
    /// <summary>
    /// 植物大战僵尸2普清版 v1.3.3; 植物大战僵尸2普清版 v1.4.1; 植物大战僵尸2普清版 v1.4.5; 植物大战僵尸2普清版 v1.5.1; 植物大战僵尸2普清版 v1.6.3; 植物大战僵尸2普清版 v1.7.1; 植物大战僵尸2普清版 v2.0.0
    /// </summary>
    public sealed class PtxHandlerPVZ2CNAndroidV3 : IPtxRsbHandler
    {
        ...
        public void DecodePtx(ReadOnlySpan<byte> ptxData, RefBitmap dstBitmap, uint width, uint height, uint pitch, uint format, uint alphaSize, ILogger logger)
        {
            ...
            {
                case 0u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A8_UByte)}", 0);
                    TextureCoder.Decode<R8_G8_B8_A8_UByte>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 1u:
                default:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R4_G4_B4_A4_UShort)}", 0);
                    TextureCoder.Decode<R4_G4_B4_A4_UShort>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 2u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R5_G6_B5_UShort)}", 0);
                    TextureCoder.Decode<R5_G6_B5_UShort>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 3u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R5_G5_B5_A1_UShort)}", 0);
                    TextureCoder.Decode<R5_G5_B5_A1_UShort>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 21u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R4_G4_B4_A4_Tile_UShort)}", 0);
                    TextureCoder.Decode<R4_G4_B4_A4_Tile_UShort>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 22u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R5_G6_B5_Tile_UShort)}", 0);
                    TextureCoder.Decode<R5_G6_B5_Tile_UShort>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 23u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R5_G5_B5_A1_Tile_UShort)}", 0);
                    TextureCoder.Decode<R5_G5_B5_A1_Tile_UShort>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 30u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A8_PVRTCI_4BPP_UByte)}", 0);
                ...
                case 31u:
                    ...
                    break;
                case 32u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_ETC1_UByte)}", 0);
                    TextureCoder.Decode<R8_G8_B8_ETC1_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 35u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_DXT1_UByte)}", 0);
                    TextureCoder.Decode<R8_G8_B8_DXT1_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 36u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A4_DXT3_UByte)}", 0);
                    TextureCoder.Decode<R8_G8_B8_A4_DXT3_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 37u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A8_DXT5_UByte)}", 0);
                    TextureCoder.Decode<R8_G8_B8_A8_DXT5_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 38u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_ATC_UByte)}", 0);
                    TextureCoder.Decode<R8_G8_B8_ATC_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 39u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A4_ATC_Explicit_UByte)}", 0);
                    TextureCoder.Decode<R8_G8_B8_A4_ATC_Explicit_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 147u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_ETC1_UByte)} and {nameof(A8_A1_UByte)}", 0);
                    ...
                    A8_A1_UByte.Decode(ptxData[tex0Size_147..], (int)width, (int)height, dstBitmap);
                    break;
                case 148u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A8_PVRTCI_4BPP_UByte)} and {nameof(A8_A1_UByte)}", 0);
                    ...
                    A8_A1_UByte.Decode(ptxData[tex0Size_148..], (int)width, (int)height, dstBitmap);
                    break;
                case 149u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A8_UByte)} and {nameof(A8_A1_UByte)}", 0);
                    ...
                    A8_A1_UByte.Decode(ptxData[tex0Size_149..], (int)width, (int)height, dstBitmap);
                    break;
                case 150u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_ETC1_UByte)} and {nameof(A8_UByte)}", 0);
                    int tex0Size_150 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);
                    TextureCoder.Decode<R8_G8_B8_ETC1_UByte>(ptxData[..tex0Size_150], (int)width, (int)height, dstBitmap);
        ...
        public void EncodePtx(RefBitmap srcBitmap, Span<byte> ptxData, uint width, uint height, uint pitch, uint format, uint alphaSize, ILogger logger)
        {
            ...
            {
                case 0u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_A8_UByte>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 1u:
                default:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R4_G4_B4_A4_UShort)}", 0);
                    TextureCoder.Encode<R4_G4_B4_A4_UShort>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 2u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R5_G6_B5_UShort)}", 0);
                    TextureCoder.Encode<R5_G6_B5_UShort>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 3u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R5_G5_B5_A1_UShort)}", 0);
                    TextureCoder.Encode<R5_G5_B5_A1_UShort>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 21u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R4_G4_B4_A4_Tile_UShort)}", 0);
                    TextureCoder.Encode<R4_G4_B4_A4_Tile_UShort>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 22u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R5_G6_B5_Tile_UShort)}", 0);
                    TextureCoder.Encode<R5_G6_B5_Tile_UShort>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 23u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R5_G5_B5_A1_Tile_UShort)}", 0);
                    TextureCoder.Encode<R5_G5_B5_A1_Tile_UShort>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 30u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_PVRTCI_4BPP_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_A8_PVRTCI_4BPP_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 31u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_PVRTCI_2BPP_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_A8_PVRTCI_2BPP_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 32u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_ETC1_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_ETC1_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 35u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_DXT1_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_DXT1_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 36u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A4_DXT3_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_A4_DXT3_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 37u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_DXT5_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_A8_DXT5_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 38u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_ATC_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_ATC_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 39u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A4_ATC_Explicit_UByte)}", 0);
                    TextureCoder.Encode<R8_G8_B8_A4_ATC_Explicit_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 147u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_ETC1_UByte)} and {nameof(A8_A1_UByte)}", 0);
                    int tex0Size_147 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);
                    TextureCoder.Encode<R8_G8_B8_ETC1_UByte>(srcBitmap, ptxData[..tex0Size_147], (int)width, (int)height);
                    A8_A1_UByte.Encode(srcBitmap, ptxData[tex0Size_147..], (int)width, (int)height);
                    break;
                case 148u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_PVRTCI_4BPP_UByte)} and {nameof(A8_A1_UByte)}", 0);
                    int tex0Size_148 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);
                    TextureCoder.Encode<R8_G8_B8_A8_PVRTCI_4BPP_UByte>(srcBitmap, ptxData[..tex0Size_148], (int)width, (int)height);
                    A8_A1_UByte.Encode(srcBitmap, ptxData[tex0Size_148..], (int)width, (int)height);
                    break;
                case 149u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_UByte)} and {nameof(A8_A1_UByte)}", 0);
                    int tex0Size_149 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);
                    TextureCoder.Encode<R8_G8_B8_A8_UByte>(srcBitmap, ptxData[..tex0Size_149], (int)width, (int)height);
                    A8_A1_UByte.Encode(srcBitmap, ptxData[tex0Size_149..], (int)width, (int)height);
                    break;
                case 150u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV3)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_ETC1_UByte)} and {nameof(A8_UByte)}", 0);
                    int tex0Size_150 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);
                    TextureCoder.Encode<R8_G8_B8_ETC1_UByte>(srcBitmap, ptxData[..tex0Size_150], (int)width, (int)height);

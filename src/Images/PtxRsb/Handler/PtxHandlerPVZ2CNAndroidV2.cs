...
namespace LibWindPop.Images.PtxRsb.Handler
{
    ...
    public sealed class PtxHandlerPVZ2CNAndroidV2 : IPtxRsbHandler
    {
        ...
        public void DecodePtx(ReadOnlySpan<byte> ptxData, RefBitmap dstBitmap, uint width, uint height, uint pitch, uint format, uint alphaSize, ILogger logger)
        {
            ...
            {
                case 0u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A8_UByte)}");
                    TextureCoder.Decode<R8_G8_B8_A8_UByte>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 1u:
                default:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R4_G4_B4_A4_UShort)}");
                    TextureCoder.Decode<R4_G4_B4_A4_UShort>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 2u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R5_G6_B5_UShort)}");
                    TextureCoder.Decode<R5_G6_B5_UShort>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 3u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R5_G5_B5_A1_UShort)}");
                    TextureCoder.Decode<R5_G5_B5_A1_UShort>(ptxData, (int)width, (int)height, (int)pitch, dstBitmap);
                    break;
                case 21u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R4_G4_B4_A4_Tile_UShort)}");
                    TextureCoder.Decode<R4_G4_B4_A4_Tile_UShort>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 22u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R5_G6_B5_Tile_UShort)}");
                    TextureCoder.Decode<R5_G6_B5_Tile_UShort>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 23u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R5_G5_B5_A1_Tile_UShort)}");
                    TextureCoder.Decode<R5_G5_B5_A1_Tile_UShort>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 30u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGBA_PVRTCI_4BPP_UByte)}");
                ...
                case 31u:
                    ...
                    break;
                case 32u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGB_ETC1_UByte)}");
                    TextureCoder.Decode<RGB_ETC1_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 35u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGB_BC1_UByte)}");
                    TextureCoder.Decode<RGB_BC1_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 36u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGBA_BC2_UByte)}");
                    TextureCoder.Decode<RGBA_BC2_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 37u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGBA_BC3_UByte)}");
                    TextureCoder.Decode<RGBA_BC3_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 38u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGB_ATC_UByte)}");
                    TextureCoder.Decode<RGB_ATC_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 39u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGBA_ATC_Explicit_UByte)}");
                    TextureCoder.Decode<RGBA_ATC_Explicit_UByte>(ptxData, (int)width, (int)height, dstBitmap);
                    break;
                case 147u:
                case 150u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGB_ETC1_UByte)} and {nameof(A8_UByte)}");
                    ...
                    break;
                case 148u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(RGBA_PVRTCI_4BPP_UByte)} and {nameof(A8_UByte)}");
                    ...
                    break;
                case 149u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(DecodePtx)} use format {nameof(R8_G8_B8_A8_UByte)} and {nameof(A8_UByte)}");
        ...
        public void EncodePtx(RefBitmap srcBitmap, Span<byte> ptxData, uint width, uint height, uint pitch, uint format, uint alphaSize, ILogger logger)
        {
            ...
            {
                case 0u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_UByte)}");
                    TextureCoder.Encode<R8_G8_B8_A8_UByte>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 1u:
                default:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R4_G4_B4_A4_UShort)}");
                    TextureCoder.Encode<R4_G4_B4_A4_UShort>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 2u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R5_G6_B5_UShort)}");
                    TextureCoder.Encode<R5_G6_B5_UShort>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 3u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R5_G5_B5_A1_UShort)}");
                    TextureCoder.Encode<R5_G5_B5_A1_UShort>(srcBitmap, ptxData, (int)width, (int)height, (int)pitch);
                    break;
                case 21u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R4_G4_B4_A4_Tile_UShort)}");
                    TextureCoder.Encode<R4_G4_B4_A4_Tile_UShort>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 22u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R5_G6_B5_Tile_UShort)}");
                    TextureCoder.Encode<R5_G6_B5_Tile_UShort>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 23u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R5_G5_B5_A1_Tile_UShort)}");
                    TextureCoder.Encode<R5_G5_B5_A1_Tile_UShort>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 30u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGBA_PVRTCI_4BPP_UByte)}");
                    TextureCoder.Encode<RGBA_PVRTCI_4BPP_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 31u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGBA_PVRTCI_2BPP_UByte)}");
                    TextureCoder.Encode<RGBA_PVRTCI_2BPP_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 32u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGB_ETC1_UByte)}");
                    TextureCoder.Encode<RGB_ETC1_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 35u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGB_BC1_UByte)}");
                    TextureCoder.Encode<RGB_BC1_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 36u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGBA_BC2_UByte)}");
                    TextureCoder.Encode<RGBA_BC2_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 37u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGBA_BC3_UByte)}");
                    TextureCoder.Encode<RGBA_BC3_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 38u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGB_ATC_UByte)}");
                    TextureCoder.Encode<RGB_ATC_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 39u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGBA_ATC_Explicit_UByte)}");
                    TextureCoder.Encode<RGBA_ATC_Explicit_UByte>(srcBitmap, ptxData, (int)width, (int)height);
                    break;
                case 147u:
                case 150u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGB_ETC1_UByte)} and {nameof(A8_UByte)}");
                    int tex0Size_147 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);
                    ...
                    break;
                case 148u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(RGBA_PVRTCI_4BPP_UByte)} and {nameof(A8_UByte)}");
                    int tex0Size_148 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);
                    ...
                    break;
                case 149u:
                    logger.Log($"{nameof(PtxHandlerPVZ2CNAndroidV2)}.{nameof(EncodePtx)} use format {nameof(R8_G8_B8_A8_UByte)} and {nameof(A8_UByte)}");
                    int tex0Size_149 = (int)GetPtxSizeWithoutAlpha(width, height, pitch, format);

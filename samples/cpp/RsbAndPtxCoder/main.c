...
int main() {
	...
	if (mode == 1) {
		sample10_regist_compressed_ptx_handler_and_unpack_rsb_for_pvz_free_android(oldPath, newPath);
	}
	else if (mode == 2) {
		sample11_regist_compressed_ptx_handler_and_pack_rsb_for_pvz_free_android(oldPath, newPath);
	}
